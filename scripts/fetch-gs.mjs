...
//   .gs/bin/gs        — pinned abhinav/git-spice build (the SHA in .gs-version,
//                       which tracks the ed-irl/integration branch) with the
//                       shamhub forge + beta integration feature compiled in.
...
/** Builds the pinned gs (+ shamhub helper). Idempotent on its marker. */
